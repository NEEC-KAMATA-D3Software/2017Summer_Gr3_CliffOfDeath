...
using System.Linq;
using System.Text;
using Microsoft.Xna.Framework.Content; //コンテンツ管理
    ...
    class Sound
    {
        ...
        private string ErrorMessage(string name)
        {
            return "再生する音データのアセット名(" + name + ")がありません\n"
                +
                "アセット名の確認、Dictionaryに登録されているか確認して下さい\n";
        }
